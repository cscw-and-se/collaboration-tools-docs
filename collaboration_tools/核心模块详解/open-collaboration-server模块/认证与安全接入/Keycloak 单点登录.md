...
**本节来源**
- [keycloak-endpoint.ts](file://packages/open-collaboration-server/src/auth-endpoints/keycloak-endpoint.ts#L1-L108)
...
**图示来源**
- [keycloak-endpoint.ts](file://packages/open-collaboration-server/src/auth-endpoints/keycloak-endpoint.ts#L1-L108)
- [oauth-endpoint.ts](file://packages/open-collaboration-server/src/auth-endpoints/oauth-endpoint.ts#L1-L211)
...
**图示来源**
- [keycloak-endpoint.ts](file://packages/open-collaboration-server/src/auth-endpoints/keycloak-endpoint.ts#L58-L92)
...
**本节来源**
- [keycloak-endpoint.ts](file://packages/open-collaboration-server/src/auth-endpoints/keycloak-endpoint.ts#L90-L107)
- [configuration.ts](file://packages/open-collaboration-server/src/utils/configuration.ts#L20-L60)
- [credentials-manager.ts](file://packages/open-collaboration-server/src/credentials-manager.ts#L34-L60)
