...
很多同学对文献综述有误解，认为它只是把别人的话复述一遍。其实不然，文献综述要做的是讲清楚一条逻辑线：这个领域前人已经做了什么、还有什么没做、以及你为什么做现在这个研究。

本文将介绍一套结合传统工具与现代 AI 技术的科研工作流，帮你高效完成文献综述。

## 第一步：检索文献 —— Google Scholar

不要用百度搜论文。做计算机科学（CS）领域的调研，Google Scholar 是首选工具。
...
下载了一堆 PDF 丢在桌面上？文件名全是 1234.pdf？等到写论文要插入参考文献时，就会很麻烦。
你需要一个文献管理软件。Zotero 也很流行且免费，而 EndNote 是学术界常用的老牌工具，很多高校（通常在学校图书馆官网）都购买了正版授权供学生免费下载。

## EndNote 能帮你做什么？

请看本文档对 [EndNote](using_endnote.md) 的描述。

## 第三步：用大模型做深度阅读

面对大量文献，每篇都从头读到尾并不现实。现在的 AI 大模型具备较强的深度研究 (Deep Research) 能力，既能帮你搜，也能帮你读。
...
文献综述不是一蹴而就的，需要不断检索、阅读、思考、再检索。用 Google Scholar 检索，用 EndNote 管理，用 AI 辅助阅读，科研其实也可以是一件有意思的事。